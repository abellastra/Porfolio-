...
export const infoProjects = [
  {
    title: "Watch-Dog — Monitoreo de Recursos",
    description:
      "Sistema de monitoreo de servidores en tiempo real, desarrollado como proyecto interno de Daztan LLC y en producción. Un agente en Go recolecta métricas de CPU, memoria, disco y red y las envía por streaming HTTP a una API que las procesa y las muestra en un dashboard con invitaciones por email, API keys y control de acceso por roles.",
    descriptionTecnic: `Flujo: Agente Go → API Fastify → BullMQ/Redis → worker → TimescaleDB → dashboard Next.js.\n\nAgente: Go. Recolecta métricas de CPU, memoria, disco y red y las envía por streaming HTTP.\n\nFrontend: Next.js + tRPC. Invitaciones por email, API keys con SHA-256 y control de acceso por roles.\n\nBase de datos: PostgreSQL + TimescaleDB con Drizzle ORM. Redis para colas con BullMQ.\n\nTesting: Integración con Testcontainers y end-to-end con Playwright.\n\nInfraestructura: Monorepo con Turborepo y pnpm. Docker, AWS EC2, nginx y GitHub Actions.`,
    tech: [
    ...
    img: "",
    imgWepp: "",
    linkGitHub: "https://github.com/Col-Trinity/monitoreo-recursos",
    linkDemo: "https://watchdog.daztanllc.com",
  },
  {
    title: "Spotia",
    description:
  ...
  },
  {
    ...
    descriptionTecnic: `Frontend: React + TypeScript con Tailwind CSS. Filtros dinámicos por nombre, tipo y generación. UI responsive con cambio de tema.\n\nBackend: API REST con Node.js + Express + TypeScript. Autenticación, validación de parámetros y endpoints escalables.\n\nBase de datos: PostgreSQL para persistencia de usuarios y favoritos.\n\nArquitectura: Frontend y backend separados, validación en ambos extremos. Contenedorizado con Docker.`,
    tech: [
      { name: "react",      img: react,      imgWepp: reactWepp },
      { name: "tailwind",   img: tailwind,   imgWepp: tailwindWepp },
      { name: "node_js",    img: nodeJs,     imgWepp: nodeJsWepp },
  ...
  },
  {
    ...
    descriptionTecnic: `Frontend: React + TypeScript. Componentes funcionales, diseño responsive y lógica de edición y eliminación.\n\nBackend: Node.js + Express + TypeScript. API REST con rutas GET, POST, PUT, DELETE para gestionar llamadas.\n\nBase de datos: MySQL con conexión mediante mysql2. Modelo relacional con inserción y consulta de registros.\n\nArquitectura: Frontend y backend separados, validación en ambos extremos, cálculo de duración total y promedio.`,
    tech: [
      { name: "react",   img: react,   imgWepp: reactWepp },
      { name: "node_js", img: nodeJs,  imgWepp: nodeJsWepp },
      { name: "ts",      img: ts,      imgWepp: tsWepp },
  ...
  },
  {
    ...
    descriptionTecnic: `Frontend: React + TypeScript con Tailwind CSS. Diseño responsive, componentes reutilizables y filtros dinámicos.\n\nBackend: Express + TypeScript. API REST con autenticación, validación de datos y CRUD sobre MySQL.\n\nBase de datos: MySQL con modelo relacional. Persistencia de usuarios y préstamos.\n\nArquitectura: Frontend y backend separados, validación en ambos extremos y manejo seguro de sesiones.`,
    tech: [
      { name: "react",   img: react,   imgWepp: reactWepp },
      { name: "ts",      img: ts,      imgWepp: tsWepp },
      { name: "tailwind",img: tailwind,imgWepp: tailwindWepp },
